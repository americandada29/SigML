...
def build_datapoint(atom, type_encoding, type_onehot, am_onehot, sig_text=None, ef=None, r_max=3.0, cor_atoms = ["Fe"]):
    ...
    if sig_text is not None:
        ...
        sig = cast_sig_over_symmetric_atoms(atom, sig, cor_atoms)
