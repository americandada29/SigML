...
def get_ixyz(lat, cutoff):
    ...
    lat2 = np.around(np.dot(lat, np.transpose(lat)), 10)
...
# @jit('Tuple((float64[:,:], float64[:,:,:,:]))(float64[:,:], float64[:,:], int64[:], int64[:], \
#       boolean, boolean, int64, int64, int64, float64)', nopython=True)
@cc.export('get_fp','Tuple((float64[:,:], float64[:,:,:,:]))(float64[:,:], float64[:,:], int64[:], int64[:], boolean, boolean, int64, int64, int64, float64)')
